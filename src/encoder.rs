use embassy_rp::{
    gpio::Pull,
    pio::{Common, Config, FifoJoin, Instance, PioPin, ShiftDirection, StateMachine},
};
use fixed::traits::ToFixed;

pub struct PioEncoder<'d, T: Instance, const SM: usize> {
    pub(crate) sm: StateMachine<'d, T, SM>,
}
...
impl<'d, T: Instance, const SM: usize> PioEncoder<'d, T, SM> {
    pub fn new(
        ...
        sm.set_pin_dirs(embassy_rp::pio::Direction::In, &[&pin_a, &pin_b]);
